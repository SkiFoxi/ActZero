...
func generateSampleLocations(count int) []*models.Location {
	// Город и регион всегда соответствуют друг другу
	cityRegions := []struct{ city, region string }{
		{"Москва", "Москва"},
		{"Санкт-Петербург", "Санкт-Петербург"},
		{"Новосибирск", "Новосибирская область"},
		{"Екатеринбург", "Свердловская область"},
		{"Казань", "Республика Татарстан"},
		{"Тамбов", "Тамбовский муниципальный округ"},
	}
	...
	for i := 0; i < count; i++ {
		pair := cityRegions[rand.Intn(len(cityRegions))]
		city := pair.city
		region := pair.region
